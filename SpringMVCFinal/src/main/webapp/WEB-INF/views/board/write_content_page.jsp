...
<!-- 파일 업로드 시 enctype 넣어줘야 함. 안넣으면 파라미터uploadfiles(파라미터명)와 파일명만 날아감  / http 프로토콜을 버퍼를 읽어들여서 버퍼를 날릴 수 있는 프로토콜로 바꾸겠다는 의미-->
...
<div class="row">
	...
	<div class="col mt-5">	<!-- 가운데 여백 -->
		...
		<div class="row">
			<div class="col">	<!-- 내용 박스 -->
				<textarea class="form-control" rows="10" cols="40" name="board_content" style="resize: none"></textarea>
			</div>
		</div>
		<div class="row mt-1">
			<div class="col">	<!-- 파일 업로드 -->
				<input type="file" name="upload_files" multiple accept="image/*">
			</div>
		</div>
		<div class="row mt-1">
			<div class="col text-right">	<!-- 글쓰기, 목록 버튼 -->
